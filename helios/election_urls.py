...
urlpatterns = patterns('',
  ...
  (r'^/trustees/(?P<trustee_uuid>[^/]+)/fullinfo$', trustees_fullinfo),
  (r'^/trustees/(?P<trustee_uuid>[^/]+)/uploadkeys$', trustee_threshold_uploadkeys),
  (r'^/trustees/(?P<trustee_uuid>[^/]+)/threshold-upload-pk$', trustee_threshold_upload_pk),
  (r'^/trustees/(?P<trustee_uuid>[^/]+)/threshold-keygenerator$', trustee_threshold_keygenerator),
  (r'^/trustees/(?P<trustee_uuid>[^/]+)/threshold-upload-encrypted-shares$', trustee_threshold_upload_encrypted_shares),
