...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trustee.user'
        db.add_column(u'helios_trustee', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['helios_auth.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trustee.user'
        db.delete_column(u'helios_trustee', 'user_id')
